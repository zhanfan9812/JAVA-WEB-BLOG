    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li><a href="selectMessage.jsp">博客查询</a></li>
                <li class="active"><a href="#">发表博客</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8">
            <form action="/LeaveMessageServlet">
                <table class="nav nav-pills nav-stacked">
                    <tr>
                        <td></td>
                        <td>
                            <input name="title" id="title" type="text" placeholder="请输入标题" class="login_button2" onBlur="return checkTitle()"/>
                            <span id="tips_title"></span>
                        </td>
                        <%--<td>
                            <span id="tips_title"></span>
                        </td>--%>
                    ...
                    <tr>
                        <td></td>
                        <td><textarea name="content" placeholder="请输入内容" class="leave_Message"></textarea></td>
                    </tr>
                    <tr>
                        <td class="selectWhite">-</td>
                    </tr>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <input type="submit"name="submit" value="发布" class="login_button1"/>
                        </td>
                    </tr>
                </table>
            </form>
